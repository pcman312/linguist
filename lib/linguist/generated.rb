module Linguist
  class Generated
    ...
    #
    #f We assume that if one of the last 2 lines starts with a source map
	...
	PROTOBUF_EXTENSIONS = ['.py', '.java', '.h', '.cc', '.cpp', '.hpp', '.rb']

    # Internal: Is the blob a C++, Java or Python source file generated by the
    # Protocol Buffer or GRPC compiler?
    #
    # Returns true or false.
    def generated_protocol_buffer?
	  ...
	  return (lines[0].include?("Generated by the protocol buffer compiler") || lines[0].include?("Generated by the gRPC")) && lines[0].include?("DO NOT EDIT")
    end
